...
const char* ViscosityImposedDepth_Name = "ViscosityImposedDepth";
const char* ViscosityImposedDepth_GetName() {
	return ViscosityImposedDepth_Name;
}

const char* ViscosityImposedDepth_Meta = NULL;
const char* ViscosityImposedDepth_GetMetadata() {
	return ViscosityImposedDepth_Meta;
}
const char* ViscosityImposedDepth_Type_GetMetadata() {
	return ViscosityImposedDepth_Meta;
}

Dictionary* ViscosityImposedDepth_MetaAsDictionary() {
	Dictionary* meta;
	Dictionary* info;
	Dictionary* code;
	...
	Dictionary_Add( meta, _xml, Dictionary_Entry_Value_FromString( ViscosityImposedDepth_Meta ));

	info = Dictionary_New();
	Dictionary_Add( info, _title, Dictionary_Entry_Value_FromString( "ViscosityImposedDepth" ));
	Dictionary_Add( info, _creator, Dictionary_Entry_Value_FromString( "Sergio Zlotnik" ));
	...
	code = Dictionary_New();
	Dictionary_Add( code, _example_code, Dictionary_Entry_Value_FromString( "\n\n" ));
...
Dictionary* ViscosityImposedDepth_Type_MetaAsDictionary() {
	return ViscosityImposedDepth_MetaAsDictionary();
}
